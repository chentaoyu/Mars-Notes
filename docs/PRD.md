...
Mars-Notes 是一款面向个人用户的轻量级在线笔记应用，专注于提供简洁、高效的 Markdown 笔记编辑与管理体验。产品以"简单、快速、可靠"为核心理念，帮助用户随时随地记录和管理自己的想法、知识和灵感。

### 1.2 产品愿景

成为最易用的个人笔记工具，让每个人都能轻松管理自己的知识库。
...
- 功能按钮：
  - **文本格式化**
    - 加粗（Bold）：快捷键 Ctrl/Cmd + B
    - 斜体（Italic）：快捷键 Ctrl/Cmd + I
    - 下划线（Underline）：快捷键 Ctrl/Cmd + U
    - 删除线（Strikethrough）：快捷键 Ctrl/Cmd + Shift + X
  - **标题设置**
    - 标题级别选择（H1-H6）
    - 下拉菜单或按钮组形式
    - 支持快捷键（Ctrl/Cmd + 1-6）
  ...
  - **列表功能**
    - 有序列表：插入有序列表标记
    - 无序列表：插入无序列表标记
    - 快捷键支持（Ctrl/Cmd + Shift + O/U）
  - **表格插入**
    - 插入表格按钮
    - 支持选择行列数（如 3x3、4x4 等）
    - 自动插入标准 Markdown 表格语法
  - **其他常用功能**
    - 插入链接
    - 插入图片
    - 插入代码块
...
> 作为一个笔记用户  
> 我想要通过工具栏快速格式化文本  
> 以便我可以更高效地编辑笔记，而不需要记忆 Markdown 语法
...
3. 输入标题内容
4. 选中一段文本，点击加粗按钮
5. 点击插入表格按钮，选择 3x3 表格
6. 在表格中填入内容
7. 使用文字大小设置调整部分文本大小
8. 所有操作实时保存，无需手动记忆 Markdown 语法
...
| 响应式设计 | 移动端适配 | 扩大使用场景 |
| 会话管理 | 自动登出和续期 | 安全性和体验 |
| 我的页面 | 个人信息管理 | 用户账户管理基础 |
| 头像替换 | 上传和更换头像 | 个性化需求 |
| 昵称修改 | 修改用户昵称 | 个性化需求 |
| 密码重置 | 修改登录密码 | 账户安全必需 |
| 账户注销 | 删除账户和数据 | 用户隐私保护 |
| 编辑器工具栏 | 格式化工具和快捷插入 | 提升编辑效率 |
